...
export type GetCategoriesAndTagsQuery = {
  __typename?: "Query";
  getCategories: Array<{ __typename?: "Category"; id: string; name: string }>;
  getTags: Array<{ __typename?: "Tag"; id: string; name: string }>;
};
...
export type ReplaceAdMutation = {
  __typename?: "Mutation";
  replaceAdById: { __typename?: "Ad"; id: string };
};
 ...
 * });
 */
export function useGetCategoriesAndTagsQuery(
  ...
  return Apollo.useQuery<
    GetCategoriesAndTagsQuery,
    GetCategoriesAndTagsQueryVariables
  >(GetCategoriesAndTagsDocument, options);
}
export function useGetCategoriesAndTagsLazyQuery(
...
export function useGetCategoriesAndTagsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type GetCategoriesAndTagsQueryHookResult = ReturnType<
  typeof useGetCategoriesAndTagsQuery
>;
export type GetCategoriesAndTagsLazyQueryHookResult = ReturnType<
  typeof useGetCategoriesAndTagsLazyQuery
>;
export type GetCategoriesAndTagsSuspenseQueryHookResult = ReturnType<
  typeof useGetCategoriesAndTagsSuspenseQuery
>;
export type GetCategoriesAndTagsQueryResult = Apollo.QueryResult<
  GetCategoriesAndTagsQuery,
  GetCategoriesAndTagsQueryVariables
>;
...
`;
export type ReplaceAdMutationFn = Apollo.MutationFunction<
  ReplaceAdMutation,
  ReplaceAdMutationVariables
>;
 ...
 * });
 */
export function useReplaceAdMutation(
  baseOptions?: Apollo.MutationHookOptions<
    ReplaceAdMutation,
    ReplaceAdMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<ReplaceAdMutation, ReplaceAdMutationVariables>(
    ReplaceAdDocument,
    options
  );
}
export type ReplaceAdMutationHookResult = ReturnType<
  typeof useReplaceAdMutation
>;
export type ReplaceAdMutationResult = Apollo.MutationResult<ReplaceAdMutation>;
export type ReplaceAdMutationOptions = Apollo.BaseMutationOptions<
  ReplaceAdMutation,
  ReplaceAdMutationVariables
>;
...
export function useGetAdQuery(
  baseOptions: Apollo.QueryHookOptions<GetAdQuery, GetAdQueryVariables> &
    ({ variables: GetAdQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetAdSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetAdQuery, GetAdQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetAdQuery, GetAdQueryVariables>(
    GetAdDocument,
    options
  );
}
...
export type GetAdSuspenseQueryHookResult = ReturnType<
  typeof useGetAdSuspenseQuery
>;
...
export function useGetAdsByCategoryQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAdsByCategoryQuery, GetAdsByCategoryQueryVariables>(
    GetAdsByCategoryDocument,
    options
  );
}
...
export function useGetAdsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetAdsQuery, GetAdsQueryVariables>
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetAdsQuery, GetAdsQueryVariables>(
    GetAdsDocument,
    options
  );
}
...
export type GetAdsSuspenseQueryHookResult = ReturnType<
  typeof useGetAdsSuspenseQuery
>;
